...
public class PathCalc {
	 ...
	 * 
	 * @param appName
	 * @param maxCacheDirAge defines after how many days the cache dir should be reinitialized,
	 * -1 to deactivate reinitialization
	 * @return
	 * @throws IOException 
	 */
    public static File getAppCacheDir(String appName, int maxCacheDirAge) {
    	if (appName.contains(File.separator) || appName.contains(File.pathSeparator)
